    ...
    <header className ="header">
      <div className="header-contents">
        <div className="row justify-content-center">
          ...
          <h6 className="col-1" onClick={() => props.view('jobDetails', {})}>Career</h6>
          <h6 className="col-1" onClick={() => props.view('cart', {})}><i className="fas fa-shopping-cart"> View Cart: </i> <span>{props.cartItemCount} </span>
          </h6>
